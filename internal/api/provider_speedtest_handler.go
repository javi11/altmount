...
func (s *Server) handleTestProviderSpeed(c *fiber.Ctx) error {
	...
	// it — otherwise fall back to the singleton coordinator. Either way
	// we route through pool.Manager rather than creating a fresh
	// nntppool.Client per request. See STREAMING_INVARIANTS.md I11.
...
// the active pool. See STREAMING_INVARIANTS.md I11.
