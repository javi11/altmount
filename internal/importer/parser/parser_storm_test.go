...
// See ../../usenet/STREAMING_INVARIANTS.md for the contract.
//
// The parser is responsible only for bounding fan-out WITHIN a single
// import job via MaxImportConnections. Cross-job budgeting is out of
