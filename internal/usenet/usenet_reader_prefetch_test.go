...
// records the high-water mark of concurrent BodyPriority calls. That single
// metric is the contract: production code that breaks any of these tests
// is regressing one of the connection-storm guarantees described in
// STREAMING_INVARIANTS.md (in this directory).
//
